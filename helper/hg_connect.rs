...
type prepare_request_cb_t =
    unsafe extern "C" fn(curl: *mut CURL, headers: *const curl_slist, data: *mut c_void);
...
extern "C" {
    ...
    fn prepare_command_request(curl: *mut CURL, headers: *const curl_slist, data: *mut c_void);
}
